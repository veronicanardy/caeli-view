...
- `CinematicHero.tsx`: orquestrador do hero. Bloco editorial central (badge, título, descrição, CTA com cena de opções), console de observação com localização integrada no cabeçalho e overlays de vignette.
