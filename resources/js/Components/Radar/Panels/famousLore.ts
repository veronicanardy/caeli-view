...
const FAMOUS_LORE: Record<string, Lore> = {
    ...
    'spacecraft:-24': {
        pt: 'A Pioneer 11 leva a mesma placa dourada da Pioneer 10, com a figura de um homem e uma mulher e o mapa de onde viemos, desenhada por Carl Sagan e Frank Drake. Em Saturno, ela descobriu um anel novo e passou a poucos milhares de quilômetros de uma lua que ninguém sabia existir, um quase acidente que virou descoberta. Sua travessia do plano dos anéis foi um teste deliberado: ela foi na frente para provar que a rota era segura antes de a Voyager 2 repeti-la.',
        en: 'Pioneer 11 carries the same golden plaque as Pioneer 10, with the figures of a man and a woman and a map of where we come from, designed by Carl Sagan and Frank Drake. At Saturn it discovered a new ring and passed within a few thousand kilometres of a moon nobody knew existed, a near miss that became a discovery. Its crossing of the ring plane was a deliberate test: it went first to prove the route was safe before Voyager 2 repeated it.',
    },
    'spacecraft:-170': {
        pt: 'Os 18 segmentos do espelho do James Webb são recobertos de ouro, mas numa camada tão fina que o telescópio inteiro usa cerca de 48 gramas, a massa de uma bola de golfe. O escudo de cinco camadas separa dois mundos: o lado do Sol passa dos 80 graus enquanto o lado dos instrumentos fica a 233 graus abaixo de zero. E há uma renúncia curiosa: para proteger os sensores, o telescópio aponta sempre para longe do Sol, então o observatório mais poderoso já construído nunca fotografa a própria Terra.',
        en: 'The 18 mirror segments of the James Webb are coated in gold, but in a layer so thin the whole telescope uses about 48 grams, the mass of a golf ball. Its five layer sunshield separates two worlds: the Sun side climbs past 80 degrees Celsius while the instrument side sits at 233 degrees below zero. And there is a curious renunciation: to protect its sensors the telescope always points away from the Sun, so the most powerful observatory ever built never photographs Earth itself.',
    },
    'spacecraft:-96': {
        pt: 'Foi a primeira missão da NASA batizada em homenagem a uma pessoa viva: Eugene Parker, o físico que previu o vento solar em 1958 num artigo que quase foi rejeitado, assistiu ao lançamento aos 91 anos. A bordo vai um cartão de memória com mais de 1,1 milhão de nomes do público, uma foto de Parker e o artigo original. O segredo da nave é um escudo de carbono de 11 centímetros: enquanto a face voltada ao Sol chega a 1.400 graus, os instrumentos atrás dele trabalham perto da temperatura ambiente.',
        en: 'It was the first NASA mission named after a living person: Eugene Parker, the physicist who predicted the solar wind in 1958 in a paper that was nearly rejected, watched the launch at age 91. On board rides a memory card with more than 1.1 million names from the public, a photo of Parker and the original paper. The spacecraft’s secret is an 11 centimetre carbon shield: while the face turned to the Sun reaches 1,400 degrees Celsius, the instruments behind it work near room temperature.',
    },
    'spacecraft:-159': {
        pt: 'A Europa Clipper é uma mensagem em garrafa em escala planetária. Sua placa metálica leva gravados o poema "In Praise of Mystery", escrito para a missão pela poeta Ada Limón, mais de 2,6 milhões de nomes do público e a palavra "água" em 103 idiomas, desenhada como ondas sonoras. Os painéis solares se estendem por 30,5 metros de ponta a ponta, o comprimento de uma quadra de basquete, porque na distância de Júpiter chega apenas um resquício da luz do Sol.',
        en: 'Europa Clipper is a message in a bottle on a planetary scale. Its metal plate carries, engraved, the poem “In Praise of Mystery”, written for the mission by poet Ada Limón, more than 2.6 million names from the public and the word “water” in 103 languages, drawn as sound waves. Its solar panels stretch 30.5 metres tip to tip, the length of a basketball court, because at Jupiter’s distance only a remnant of sunlight arrives.',
    },
};
