...
export const BODIES: Record<BodyId, BodyConfig> = {
    ...
    moon: {
        ...
        facts: [
            ...
            { labelPt: 'Temperatura média',   labelEn: 'Temperature (avg.)',   value: '~−20 °C (de −173 °C à noite a +127 °C de dia) / ~−20 °C (−173 °C at night to +127 °C by day)' },
        ],
    ...
    uranus: {
        ...
        historyPt: 'Urano tem a honra de ser o primeiro planeta descoberto com telescópio. William Herschel o identificou em 1781 pensando ser um cometa, e levou um tempo até que os cálculos de sua órbita revelassem que era um planeta. O nome vem do deus grego do céu primordial, pai de Saturno e avô de Zeus. A única sonda a visitá-lo foi a Voyager 2, em 1986, que revelou um mundo inclinado de lado: seu eixo de rotação é tão oblíquo que Urano orbita o Sol quase como uma bola rolando. Uma de suas peculiaridades mais poéticas está nos nomes de suas luas. Ao contrário de todos os outros planetas, cujos satélites levam nomes da mitologia greco-romana, as luas de Urano foram batizadas com personagens de Shakespeare e Alexander Pope.',
        historyEn: 'Uranus has the distinction of being the first planet discovered with a telescope. William Herschel identified it in 1781 thinking it was a comet, and it took time before orbital calculations revealed it was a planet. The name comes from the Greek god of the primordial sky, father of Saturn and grandfather of Zeus. The only spacecraft to visit it was Voyager 2, in 1986, which revealed a world tilted on its side: its rotational axis is so oblique that Uranus orbits the Sun almost like a rolling ball. One of its most poetic peculiarities lies in the names of its moons. Unlike every other planet, whose satellites carry names from Greco-Roman mythology, the moons of Uranus were named after characters from Shakespeare and Alexander Pope.',
    },
    neptune: {
        namePt: 'Netuno',
        nameEn: 'Neptune',
