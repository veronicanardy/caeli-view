        ...
        <section>
            ...
            <div
                ...
                className={fullscreen
                    ? 'fixed inset-0 z-50 bg-[#171b22] [background-image:radial-gradient(ellipse_72%_58%_at_50%_40%,#30343a_0%,#22262d_48%,#171b22_100%)] lg:cursor-grab lg:active:cursor-grabbing touch-none'
                    : 'relative h-[calc(100dvh-7rem)] min-h-[360px] sm:h-[calc(100vh-8rem)] sm:min-h-[400px] lg:min-h-[560px] overflow-hidden rounded-lg border border-white/10 bg-[#171b22] [background-image:radial-gradient(ellipse_72%_58%_at_50%_40%,#30343a_0%,#22262d_48%,#171b22_100%)] lg:cursor-grab lg:active:cursor-grabbing touch-none'}
