...
export const RADAR_TUTORIAL_STEPS: TutorialStep[] = [
    ...
    },
    {
        ...
        bodyEn: 'The line is the rock\'s estimated trajectory and the arrow shows where it is heading. The [[−24h]], [[−48h]] and [[−72h]] markers show where it was before. Feel free to rotate the screen, explore the scene and get a sense of the object\'s path over time.',
        primaryLabelPt: 'Entendi',
        primaryLabelEn: 'Got it',
    },
    {
