...
export const RADAR_TUTORIAL_STEPS: TutorialStep[] = [
    ...
    },
    {
        ...
        bodyPt: '[[Mais próximos agora]] mostra quem está mais perto agora. [[Próximas aproximações]] mostra quem passa em breve. Troque o critério para continuar.',
        bodyEn: '[[Closest now]] shows what is nearest right now. [[Upcoming passes]] shows what is coming soon. Switch the criterion to continue.',
        bodyMobilePt: 'Abra os filtros e troque entre [[Mais próximos agora]] e [[Próximas aproximações]].',
        bodyMobileEn: 'Open the filters and switch between [[Closest now]] and [[Upcoming passes]].',
    },
    {
        id: 'filter-limit',
        audience: 'all',
    ...
    },
    {
        ...
        bodyPt: 'Este card resume o objeto escolhido: distância, velocidade, status e risco.',
        bodyEn: 'This card sums up your chosen object: distance, speed, status and risk.',
        primaryLabelPt: 'Entendi',
        primaryLabelEn: 'Got it',
    },
    {
        ...
        bodyPt: 'A aba [[Resumo]] já está aberta com o essencial: distância, velocidade, risco e status.',
        bodyEn: 'The [[Summary]] tab is already open with the essentials: distance, speed, risk and status.',
        primaryLabelPt: 'Entendi',
        primaryLabelEn: 'Got it',
    },
    {
        ...
        bodyPt: 'Clique em [[Perfil físico]] para ver tamanho, composição e classe orbital do objeto.',
        bodyEn: 'Click [[Physical profile]] to see the object\'s size, composition and orbital class.',
    },
    {
        ...
        bodyPt: 'Cada rocha tem características únicas. Gigantes lentas, minúsculas velozes, a diversidade aqui é impressionante.',
        bodyEn: 'Each rock has unique traits. Slow giants, tiny speedsters, the diversity here is impressive.',
        primaryLabelPt: 'Entendi',
        primaryLabelEn: 'Got it',
    },
    {
