/**
 * Conteúdo estático de apresentação dos corpos celestes usados pelos painéis.
 *
 * Este arquivo guarda textos, rótulos e fatos exibidos no BodyInfoCard. Ele não
 * deve calcular posição, órbita, efeméride ou qualquer dado dinâmico da cena.
 */
