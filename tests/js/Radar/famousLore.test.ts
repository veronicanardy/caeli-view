/**
 * Garante que famousLoreFor cobre todos os famosos (5 asteroides + 4 cometas) em PT e EN, devolve
 * null para objetos sem lore (asteroide comum do feed) e respeita o estilo do produto (sem travessão).
 */
