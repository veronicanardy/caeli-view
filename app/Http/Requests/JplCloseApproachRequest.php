...
class JplCloseApproachRequest extends FormRequest
{
        ...
        $validator->after(function (Validator $validator): void {
            if ($this->filled('date_min') && $this->filled('date_max')) {
                ...
                if ($start->diffInDays($end) > 90) {
                    $validator->errors()->add('date_max', 'Observe intervalos de até 90 dias por vez para manter a consulta estável.');
                }
            }
